...
public class SolutionControllerTest {
  ...
  /**
   * This test checks the getEntities method of the SolutionController. It verifies that all
   * Solutions are retrieved when the method is called.
   */
  @Test
  @Disabled
  public void getSolutions_retrievesAllSolutions() {
    when(service.getAll(pageable)).thenReturn(Page.empty());
    when(mapper.toDto(any())).thenReturn(new SolutionResponse());

    Page<SolutionResponse> responses = controller.getEntities(pageable);
