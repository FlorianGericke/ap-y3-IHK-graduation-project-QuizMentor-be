    ...
    return httpSecurity
        ...
        .authorizeHttpRequests(auth ->
            auth
                ...
                // Only allow POST requests to answer, quiz, and question endpoints if the user has TRAINER, MENTOR, or TRAINEE authority
                .requestMatchers(
                ...
                // Only allow PUT, PATCH, and DELETE requests to answer, quiz, and question endpoints if the user has TRAINER or MENTOR authority
                .requestMatchers(
                ...
                // Only allow requests to register, and PUT, PATCH, and DELETE requests to user endpoint if the user has TRAINER authority
                .requestMatchers(
