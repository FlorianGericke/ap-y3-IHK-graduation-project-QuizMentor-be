...
public abstract class BaseController<
   ...
   */
  public BaseController(Service service, Response response) {
  ...
  public @ResponseBody Response postEntity(@RequestBody Request request) {
  ...
  public @ResponseBody Page<Response> getEntities(Pageable pageable) {
  ...
  public @ResponseBody Response getEntity(@PathVariable UUID id) {
  ...
  public @ResponseBody Response putEntity(@PathVariable UUID id, @RequestBody Request request) {
  ...
  public @ResponseBody Response patchEntity(@PathVariable UUID id, @RequestBody Request request) {
