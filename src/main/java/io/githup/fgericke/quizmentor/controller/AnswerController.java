...
public class AnswerController extends
   ...
   * @param answerResponse The response to be used.
   */
  @Autowired
  public AnswerController(final AnswerService service, final AnswerResponse answerResponse) {
    super(service, answerResponse);
  }
}
