...
public class Quiz extends BaseEntity {
   ...
   * owner, and each user can own multiple quizzes. The 'owner_id' in @JoinColumn indicates that the
   * 'owner_id' field in the User entity owns the relationship (contains the foreign key). The
   *
   * @Exclude annotation is used to exclude this field from the toString method generated by
   * Lombok.
   */
  @Exclude
  @ManyToOne
